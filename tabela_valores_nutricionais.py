valores_nutricionais_dict = {
    # Grãos e massas
    'arroz': {'calorias': 130, 'proteinas': 2.7, 'carboidratos': 28.1, 'gorduras': 0.3},
    'feijao': {'calorias': 95, 'proteinas': 6.6, 'carboidratos': 17.7, 'gorduras': 0.4},
    ...
    'ovo': {'calorias': 78, 'proteinas': 6.3, 'carboidratos': 0.6, 'gorduras': 5.3},
    'queijo': {'calorias': 402, 'proteinas': 25, 'carboidratos': 1.3, 'gorduras': 33},

    # Vegetais e legumes
    'batata': {'calorias': 77, 'proteinas': 2, 'carboidratos': 17, 'gorduras': 0.1},
    'cenoura': {'calorias': 41, 'proteinas': 1, 'carboidratos': 10, 'gorduras': 0.2},
    'tomate': {'calorias': 18, 'proteinas': 0.9, 'carboidratos': 3.9, 'gorduras': 0.2},
    'abobrinha': {'calorias': 17, 'proteinas': 1.2, 'carboidratos': 3.1, 'gorduras': 0.3},
    'brocolis': {'calorias': 55, 'proteinas': 3.7, 'carboidratos': 11.2, 'gorduras': 0.6},
    ...
    'achocolatado': {'calorias': 83, 'proteinas': 1.9, 'carboidratos': 14.7, 'gorduras': 1.4},
    'água de coco': {'calorias': 19, 'proteinas': 0.7, 'carboidratos': 3.7, 'gorduras': 0.2},
